...
const Popup = ({ setUpdateTable, setOpenPopup }: PropsType) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-screen bg-[#00000070] grid place-items-center">
      <div className="bg-white w-[700px] py-8 rounded-lg text-center relative">
        ...
        <h2 className="text-2xl -mt-3 text-pink font-extrabold">
          Edit Product
        </h2>

        <form className="mt-6 w-fit space-y-4 mx-auto" onSubmit={handleSubmit}>
          <div className="flex flex-col items-start gap-x-2">
            <label htmlFor="name" className="text-md font-bold text-black">
              Name:
            </label>
            <input
              type="text"
          ...
          <div className="flex flex-col items-start gap-x-2">
            <label htmlFor="category" className="text-md font-bold text-black">
              Category:
            </label>
            <input
              type="text"
          ...
          <div className="flex flex-col items-start gap-x-2">
            <label htmlFor="price" className="text-md font-bold text-black">
              Price:
            </label>
            <input
              type="text"
