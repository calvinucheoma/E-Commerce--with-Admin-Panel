    ...
    <div className="pt-4 bg-white top-0 sticky">
      <div className="container">
        <div className="flex justify-between items-center">
          <div className="text-4xl font-bold text-pink">Gilrenn</div>

          <div className="lg:flex hidden w-full max-w-[500px]">
            <input
              type="text"
              placeholder="Search for products..."
              className="border-2 border-accent px-6 py-2 w-full outline-none"
            />

            <div className="bg-accent text-white grid place-items-center px-4 text-[26px]">
              <BsSearch />
            </div>
          </div>
          ...
          <div className="flex gap-4 md:gap-8 items-center">
            <div className="md:flex hidden gap-3">
              ...
              <div>
                <p className="text-gray-500">Hello, please sign in to</p>
